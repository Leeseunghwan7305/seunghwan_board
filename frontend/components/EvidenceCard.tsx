...
export default function EvidenceCard({ citation }: { citation: Citation }) {
  return (
    <article className="flex overflow-hidden rounded-2xl border border-line bg-card shadow-sm transition-transform motion-safe:duration-150 motion-safe:hover:-translate-y-0.5 hover:border-primary/60">
